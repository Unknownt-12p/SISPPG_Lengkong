    ...
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header bg-white py-3 d-flex align-items-center">
                ...
                <h5 class="card-title mb-0 fw-bold"><i class="fa-solid fa-bowl-food text-success me-2"></i>Ubah Data Menu Makanan</h5>
            </div>

            <!-- Form -->
            <form action="{{ route('admin.menu.update', $menu->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kode_menu" id="kode_menu" 
                                   ...
                                   value="{{ old('kode_menu', $menu->kode_menu) }}" readonly required>
                            @error('kode_menu')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="kategori_menu" id="kategori_menu" 
                                ...
                                <option value="Anak TK" {{ old('kategori_menu', $menu->kategori_menu) === 'Anak TK' ? 'selected' : '' }}>Anak TK</option>
                                <option value="Anak SD" {{ old('kategori_menu', $menu->kategori_menu) === 'Anak SD' ? 'selected' : '' }}>Anak SD</option>
                                <option value="Balita" {{ old('kategori_menu', $menu->kategori_menu) === 'Balita' ? 'selected' : '' }}>Balita</option>
                                <option value="Ibu Hamil" {{ old('kategori_menu', $menu->kategori_menu) === 'Ibu Hamil' ? 'selected' : '' }}>Ibu Hamil</option>
                                <option value="Ibu Menyusui" {{ old('kategori_menu', $menu->kategori_menu) === 'Ibu Menyusui' ? 'selected' : '' }}>Ibu Menyusui</option>
                            </select>
                            @error('kategori_menu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="kalori" id="kalori" 
                                       ...
                                       value="{{ old('kalori', $menu->kalori) }}" min="0" required>
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="protein" id="protein" 
                                       ...
                                       value="{{ old('protein', $menu->protein) }}" min="0" required>
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="karbohidrat" id="karbohidrat" 
                                       ...
                                       value="{{ old('karbohidrat', $menu->karbohidrat) }}" min="0" required>
                                <span class="input-group-text">g</span>
                            </div>
                            @error('karbohidrat')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="col-md-3 col-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" name="lemak" id="lemak" 
                                       ...
                                       value="{{ old('lemak', $menu->lemak) }}" min="0" required>
                                <span class="input-group-text">g</span>
                            </div>
                            @error('lemak')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                ...
                <div class="card-footer bg-white border-top py-3 d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-success rounded-pill px-4">
                        <i class="fa-solid fa-save me-1"></i> Perbarui Menu
                    </button>
                </div>
            </form>
        </div>
